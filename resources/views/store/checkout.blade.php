            ...
            <div id="cashup-section" class="hidden relative overflow-hidden rounded-2xl shadow-xl border-2 border-emerald-300 bg-gradient-to-br from-emerald-50 via-white to-teal-50">
                ...
                <div class="relative p-6 md:p-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-slate-900">دفع رسوم التوصيل</h2>
                    ...
                    <div id="cashup-step2" class="space-y-5 hidden">
                        ...
                        <div id="cashup-instapay-warning" class="hidden p-4 bg-amber-50 border border-amber-200 rounded-xl text-amber-800 text-sm leading-relaxed">
                            <strong>خلي بالك:</strong> إن ده رقم محفظة مش حساب انستا باي بنكي. بعد ما تحول، ابعتلي هنا الرقم اللي حولت منه أو صورة التحويل عشان أأكدلك الأوردر فوراً.
                        </div>
                        ...
                        <div id="cashup-instapay-input" class="hidden">
                            <label class="block text-sm font-medium text-slate-700 mb-2">الاسم كما يظهر في تطبيق البنك أو رقم المحفظة اللي حولت منها</label>
                            <input type="text" id="cashup-sender-name" class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200" placeholder="أدخل الاسم أو الرقم">
                        </div>
...
(function() {
    ...
    document.getElementById('cashup-validate-btn')?.addEventListener('click', function() {
        ...
        if (method === 'wallet') {
            ...
            senderId = document.getElementById('cashup-sender-name').value.trim();
            if (senderId.length < 2) {
                showMsg('أدخل الاسم بشكل صحيح', 'error');
                return;
            }
        } else {
