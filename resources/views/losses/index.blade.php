...
<div class="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div class="min-w-0">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">الخسائر</h1>
...
<div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
    <p class="text-sm text-red-800">
        <span class="font-semibold">إجمالي الخسائر:</span>
        <span class="font-bold text-lg">{{ number_format($totalLosses ?? 0, 2) }} ج.م</span>
        <span class="text-red-600 mr-2">(محسوب من سعر التكلفة عند التلف × الكمية لكل عملية)</span>
    </p>
</div>
