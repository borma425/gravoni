...
<div class="mb-8 flex items-center justify-between">
    <div>
        <h1 class="text-3xl font-bold text-gray-900">رسوم المحافظات</h1>
        <p class="mt-2 text-sm text-gray-600">إدارة رسوم الشحن لكل محافظة</p>
    </div>
    <a href="{{ route('governorates.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-slate-700 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-colors">
